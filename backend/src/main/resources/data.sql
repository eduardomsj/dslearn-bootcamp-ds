...
INSERT INTO tb_resource (title, description, position, img_uri, type, offer_id) VALUES ('Lives', 'Lives exclusivas', 3, 'https://cdn.pixabay.com/photo/2018/03/22/10/55/training-course-3250007_1280.jpg', 0, 1);
...
INSERT INTO tb_content (id, text_content, video_uri) VALUES (1, 'Material de apoio 1', 'https://www.youtube.com/watch?v=lLg4Rqd_V_k');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Aula 2 Capítulo 1', 2, 1);
INSERT INTO tb_content (id, text_content, video_uri) VALUES (2, 'Material de apoio 2', 'https://www.youtube.com/watch?v=lLg4Rqd_V_k');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Aula 3 Capítulo 1', 3, 1);
INSERT INTO tb_content (id, text_content, video_uri) VALUES (3, 'Material de apoio 3', 'https://www.youtube.com/watch?v=lLg4Rqd_V_k');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Tarefa 1 Capítulo 1', 3, 1);
INSERT INTO tb_task (id, description, question_count, approval_count, weight, due_date) VALUES (4, 'Todo task', 5, 4, 1.0, TIMESTAMP WITH TIME ZONE '2020-11-25T00:00:00Z');
